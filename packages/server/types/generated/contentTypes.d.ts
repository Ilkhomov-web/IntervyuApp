...
export interface ApiAttemptAttempt extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Foydalanuvchi urinishlari (statistika uchun)';
    displayName: 'Attempt';
    pluralName: 'attempts';
  ...
  attributes: {
    aiEvaluation: Schema.Attribute.Text;
    ...
    kind: Schema.Attribute.Enumeration<['question', 'practical', 'review']> &
      Schema.Attribute.Required &
    ...
    > &
      Schema.Attribute.Private;
    practicalTask: Schema.Attribute.Relation<
      'manyToOne',
    ...
    timeSpentSeconds: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
...
export interface ApiLevelLevel extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Junior / Middle / Senior darajalari';
    displayName: 'Level';
    pluralName: 'levels';
    singularName: 'level';
  };
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::level.level'> &
      Schema.Attribute.Private;
    minAverageScore: Schema.Attribute.Integer &
      Schema.Attribute.SetMinMax<
        {
          max: 100;
          min: 0;
    ...
    minTopicsCompleted: Schema.Attribute.Integer &
      Schema.Attribute.DefaultTo<0>;
    name: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
...
export interface ApiPracticalTaskPracticalTask
  extends Struct.CollectionTypeSchema {
  collectionName: 'practical_tasks';
  info: {
    description: 'Amaliy topshiriqlar (kod yozish)';
    displayName: 'Practical Task';
    pluralName: 'practical-tasks';
    singularName: 'practical-task';
  };
  options: {
  ...
  attributes: {
    ...
    estimatedMinutes: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<30>;
    ...
    solutionCode: Schema.Attribute.Text;
    starterCode: Schema.Attribute.Text;
...
export interface ApiQuestionQuestion extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Test va ochiq savollar';
...
export interface ApiReviewScheduleReviewSchedule
  extends Struct.CollectionTypeSchema {
  collectionName: 'review_schedules';
  info: {
    description: 'Spaced repetition (SM-2 algoritmi). Mavzular qachon qaytarilishini boshqaradi.';
    displayName: 'Review Schedule';
    pluralName: 'review-schedules';
    singularName: 'review-schedule';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    easeFactor: Schema.Attribute.Decimal &
      Schema.Attribute.SetMinMax<
        {
          min: 1.3;
        },
        number
      > &
      Schema.Attribute.DefaultTo<2.5>;
    ...
    lastScore: Schema.Attribute.Integer &
      Schema.Attribute.SetMinMax<
        {
          max: 100;
          min: 0;
    ...
    > &
      Schema.Attribute.Private;
    nextReviewDate: Schema.Attribute.Date & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiStudyPlanStudyPlan extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: '10 kunlik / 1 oy / 2 oy reja variantlari';
  ...
  attributes: {
    ...
    durationDays: Schema.Attribute.Integer &
      ...
      Schema.Attribute.SetMinMax<
        ...
        number
      >;
    includedLevels: Schema.Attribute.JSON;
    ...
    > &
      Schema.Attribute.Private;
    minImportance: Schema.Attribute.Integer &
      Schema.Attribute.SetMinMax<
        {
          max: 10;
          min: 1;
...
export interface ApiTopicTopic extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: "O'qish mavzulari (Closures, Hooks, System Design...)";
    displayName: 'Topic';
    pluralName: 'topics';
    singularName: 'topic';
  };
  ...
  attributes: {
    ...
    practicalTasks: Schema.Attribute.Relation<
      'oneToMany',
      'api::practical-task.practical-task'
    >;
    prerequisites: Schema.Attribute.Relation<'manyToMany', 'api::topic.topic'>;
    publishedAt: Schema.Attribute.DateTime;
    questions: Schema.Attribute.Relation<'oneToMany', 'api::question.question'>;
    slug: Schema.Attribute.UID<'title'> & Schema.Attribute.Required;
    tags: Schema.Attribute.JSON;
    theory: Schema.Attribute.RichText;
    title: Schema.Attribute.String & Schema.Attribute.Required;
    track: Schema.Attribute.Relation<'manyToOne', 'api::track.track'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiTrackTrack extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: "Frontend / Fullstack kabi yo'nalishlar";
    displayName: 'Track';
    pluralName: 'tracks';
    singularName: 'track';
  };
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    slug: Schema.Attribute.UID<'name'> & Schema.Attribute.Required;
    studyPlans: Schema.Attribute.Relation<
      'oneToMany',
      'api::study-plan.study-plan'
    >;
    topics: Schema.Attribute.Relation<'oneToMany', 'api::topic.topic'>;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::practical-task.practical-task': ApiPracticalTaskPracticalTask;
      'api::question.question': ApiQuestionQuestion;
      'api::review-schedule.review-schedule': ApiReviewScheduleReviewSchedule;
